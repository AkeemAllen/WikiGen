<script lang="ts">
  ...
  import PokemonGeneration from "$lib/components/PokemonGeneration.svelte";
...
<Tabs.Root value="generation" class="w-full">
  ...
  <Tabs.Content value="generation" class="mx-5">
    <PokemonGeneration />
  </Tabs.Content>
  <Tabs.Content value="new-pokemon">
    <!-- <NewPokemonPanel /> -->
  </Tabs.Content>
  <Tabs.Content value="movesets">
    <!-- <ModifyMovesets /> -->
  </Tabs.Content>
</Tabs.Root>
